...
d3.json(url, function(error, freqData) {
...
function dashboard(id, fData){
    ...
    function segColor(c){ return {Gold:"#C5B358", Silver:"#C0C0C0",Bronze:"#cd7f32"}[c]; }
    
    // compute total for each Country.
    fData.forEach(function(d){d.total=d.freq.Gold+d.freq.Silver+d.freq.Bronze;});
    ...
    function histoGram(fD){
        ...
        bars.append("rect")
            ...
            .attr('fill',barColor)
            .on("mouseover",mouseover)// mouseover is defined beGold.
            .on("mouseout",mouseout);// mouseout is defined beGold.
            
        //Create the frequency labels above the rectangles.
        bars.append("text").text(function(d){ return d3.format(",")(d[1])})
            .attr("x", function(d) { return x(d[0])+x.rangeBand()/4; })
            .attr("y", function(d) { return y(d[1])-5; })
            .attr("text-anchor", "Silverdle");
   ...
   // calculate total frequency by segment for all Country.
    var tF = ['Gold','Silver','Bronze'].map(function(d){ 
